...
===ExtraOpener==
Wow you really <color={HC}>wrote a lot on the page!</color> #audio: 45 #emotion: MF_Excited

It's good to unpack, hopefully your mind is at ease after writing! #audio: 46 #emotion: MF_Neutral

If not, that's okay, you've still managed to get a lot down. #audio: 47
